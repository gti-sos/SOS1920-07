...
<script>
    ...
    async function loadGraph2(){
            ...
            const resDataG2 = await fetch("https://servicios.ine.es/wstempus/js/es/DATOS_TABLA//t26/p067/p01/serie/l0//01004.px?tip=AM");
            if (resDataG2.ok) {
            ...
            Highcharts.chart('container', {
                    ...
                    xAxis: {
                        allowDecimals: false,
                        categories: ['Toneladas Exportadas', 'Dólares Exportados', 'Toneladas Importadas', 'Dólares Importados', 'Volumen total de agua registrada y distribuida por tipo de usuario'],
                        title: {
                            text: 'Datos'
                        },
                    },
    ...
    <svelte:head>
      ...
      <main>
        <figure class="highcharts-figure">
            ...
            <p class="highcharts-description">Gráfica integrada con api externa 1</p>
        </figure>
        <p>
