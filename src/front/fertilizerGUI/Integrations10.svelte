...
<script>
    ...
    async function loadGraph2(){
            ...
            const resDataG2 = await fetch("https://servicios.ine.es/wstempus/js/es/DATOS_TABLA//t26/e068/p04/serie/l0/01002.px?tip=AM");
            if (resDataG2.ok) {
            ...
            Highcharts.chart('container', {
                    ...
                    xAxis: {
                        allowDecimals: false,
                        categories: ['Toneladas Exportadas', 'Dólares Exportados', 'Toneladas Importadas', 'Dólares Importados', 'Recuperación residuos'],
                        title: {
                            text: 'Datos'
                        },
                    },
    ...
    <svelte:head>
      ...
      <main>
        <figure class="highcharts-figure">
            ...
            <p class="highcharts-description">Gráfica integrada con api externa 9</p>
        </figure>
        <p>
