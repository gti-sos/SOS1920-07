...
<script>
    ...
    async function loadGraph2(){
            ...
            const resDataG2 = await fetch("https://servicios.ine.es/wstempus/js/es/DATOS_TABLA//t26/e068/p01/serie/l0/02003.px?tip=AM");
            if (resDataG2.ok) {
            ...
            dataG2.forEach(elementG2 => {
                    ourData.push({
                        name: ['Residuos en ' + elementG2.NombrePeriodo], 
            ...
            Highcharts.chart('container', {
                    ...
                    xAxis: {
                        allowDecimals: false,
                        categories: ['Toneladas Exportadas', 'Dólares Exportados', 'Toneladas Importadas', 'Dólares Importados', 'Residuos domésticos y similares'],
                        title: {
                            text: 'Datos'
                        },
                    },
    ...
    <svelte:head>
      ...
      <main>
        <figure class="highcharts-figure">
            ...
            <p class="highcharts-description">Gráfica integrada con api externa 8</p>
        </figure>
        <p>
