    ...
    <div class="row">
        <div class="col-4">
          <div class="list-group" id="list-tab" role="tablist">
            ...
            <button   on:click="{() => api_active = 1}" on:click="{showgraph}" >Integración con 01 emigrants-stats</button>
            <button   on:click="{() => api_active = 2}" on:click="{showgraph}">Integración con 02 emigrants-stats</button>
